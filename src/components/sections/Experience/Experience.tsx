      ...
      <div className={styles.inner}>
        ...
        <div className={styles.timeline} role="list">
          {experienceItems.map((item, i) => {
            const translated = messages.experience.items[i];
            return (
              <AnimatedSection key={i} delay={0.1} className={styles.item} role="listitem">
                ...
                <div className={styles.card}>
                  ...
                  <p className={styles.description}>{translated?.description ?? item.description}</p>

                  <p className={styles.responsibilitiesTitle}>{t('experience.keyResponsibilities')}</p>
